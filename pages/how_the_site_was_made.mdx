...
<Container>
    ...
    Basically, I imported a bunch of components from the Hack Club Theme UI toolkit, and then created instances of those in a markdown file (.mdx). This uses some HTML syntax and some JavaScript syntax, if you're familiar with those. <br />
    If you want to create a website like this of your own, email me at <Link href="mailto:tprole@havergal.on.ca">tprole@havergal.on.ca</Link>!
